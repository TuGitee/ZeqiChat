...
pool.query('CREATE TABLE IF NOT EXISTS world (world_msg_id INT NOT NULL AUTO_INCREMENT,message VARCHAR(1023) NOT NULL,from_id INT NOT NULL,create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,PRIMARY KEY (world_msg_id))')
